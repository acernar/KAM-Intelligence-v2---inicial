...
SUBCATEGORIAS_CLAVE = [
    ...
    ('AZURE', 'Nube/Azure'),
    ('AWS', 'Nube/AWS'),
    ('HUAWEI', 'Infraestructura/Huawei'),
    ('OCEANSTOR', 'Almacenamiento/Huawei'),
    ('FORTINET', 'Seguridad Web'),
    ('FORTIGATE', 'Seguridad Web'),
    ('FIREWALL', 'Seguridad Web'),
    ('VOIP', 'VoIP'),
    ('TELEFON', 'Telefonía IP'),
    ('ANEXOS VIRTUALES', 'Telefonía IP'),
    ('SIP TRUNK', 'Telefonía IP'),
    ('SEGURIDAD', 'Seguridad Web'),
    ('CIBERSEGURIDAD', 'Seguridad Web'),
    ('VMWARE', 'Software/Virtualización'),
    ('VSPHERE', 'Software/Virtualización'),
    ('RED HAT', 'Software'),
    ('RHEL', 'Software'),
    ('CISCO', 'Redes y Conectividad'),
    ('ARUBA', 'Redes y Conectividad'),
    ('SWITCH', 'Redes y Conectividad'),
    ('ROUTER', 'Redes y Conectividad'),
    ('WIFI', 'Redes y Conectividad'),
    ('ACCESS POINT', 'Redes y Conectividad'),
    ('INTERNET DEDICADO', 'Redes y Conectividad'),
    ('CABLEADO', 'Cableado Estructurado'),
    ('FURUKAWA', 'Cableado Estructurado'),
    ...
    ('LIEBERT', 'Energía TI'),
    ('APC', 'Energía TI'),
    ('HOSTING', 'Nube/Hosting'),
    ('ALOJAMIENTO WEB', 'Nube/Hosting'),
    ('BASE DE DATOS', 'Base de Datos'),
    ('ORACLE', 'Base de Datos'),
    ('SQL SERVER', 'Base de Datos'),
    ('TRAMITE DOCUMENTARIO', 'Gestión Documental'),
    ('GESTION DOCUMENTAL', 'Gestión Documental'),
    ('MESA DE PARTES', 'Gestión Documental'),
    ('PANTALLA INTERACTIVA', 'Pantallas Interactivas'),
    ('PIZARRA DIGITAL', 'Pantallas Interactivas'),
    ('ESCANER', 'Impresión y Digitalización'),
    ('SCANNER', 'Impresión y Digitalización'),
    ('IMPRESORA', 'Impresión y Digitalización'),
    ('VIDEOVIGILANCIA', 'Videovigilancia'),
    ('HIKVISION', 'Videovigilancia'),
    ('DAHUA', 'Videovigilancia'),
    ...
    if not df_menores.empty and 'fuente' in df_menores.columns:
        for _, row in df_menores[df_menores['fuente'].astype(str).str.contains('OECE', case=False, na=False)].iterrows():
            filas_oece.append({
                ...
                'Categoría oficial': row.get('categoria_oficial', ''),
                'Familia KAM': row.get('categoria_kam', ''),
                'Subcategoría KAM': row.get('subcategoria_kam', row.get('subcategoria', '')),
                'Código oficial': row.get('codigo_clasificacion', ''),
                'Confianza clasificación': row.get('confianza_clasificacion', 'REVISAR'),
    ...
    if not df_licitaciones.empty and 'fuente' in df_licitaciones.columns:
        for _, row in df_licitaciones[df_licitaciones['fuente'].astype(str).str.contains('OECE', case=False, na=False)].iterrows():
            filas_oece.append({
                ...
                'Categoría oficial': row.get('categoria_oficial', ''),
                'Familia KAM': row.get('categoria_kam', ''),
                'Subcategoría KAM': row.get('subcategoria_kam', row.get('subcategoria_ti', '')),
                'Código oficial': row.get('codigo_clasificacion', ''),
                'Confianza clasificación': row.get('confianza_clasificacion', 'REVISAR'),
